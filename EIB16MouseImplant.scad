...
translate([-1.3000, 0.0000, 0])
        cylinder(h = 1+0.25, r = 0.34, $fn=60);
// Hole from [0.21, 4.15, 3.75] to [0.4, 4.2, -2.5]
translate([0.4000, 4.2000, 1.0000])
rotate(a = 4.0865, v = [0.2545, -0.9671, -0.0000])
    cylinder(h = 3.9570, r = 0.34, $fn=60);
translate([0.4000, 4.2000, 0])
        cylinder(h = 1+0.25, r = 0.34, $fn=60);
// Hole from [-0.92, 4.15, 3.75] to [-0.4, 4.2, -2.5]
translate([-0.4000, 4.2000, 1.0000])
...
translate([2.0000, 2.5000, 1.0000])
...
translate([1.0000, -3.5000, 1.0000])
